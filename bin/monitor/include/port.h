...
typedef unsigned int (*in_func_t)(unsigned int port);
extern in_func_t in_funcs[];
extern unsigned int inb(unsigned int port);
extern unsigned int inw(unsigned int port);
extern unsigned int ind(unsigned int port);

typedef void (*out_func_t)(unsigned int port, unsigned int value);
extern out_func_t out_funcs[];
...
int guest_ports_accessible(unsigned short port, unsigned short bytes);
