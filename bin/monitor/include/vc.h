...
extern struct video_save_struct linux_regs, all_dosemu_regs[MAX_OSS];
extern struct video_save_struct *dosemu_regs;
...
extern struct screen_stat scr_state[MAX_OSS];
extern int current_console;
#define SCR_STATE   scr_state[current_console]
