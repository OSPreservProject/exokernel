 ...
 */
/* HECTOR: added the define TEXT_START_ADDRESS, if defined it controls
 * the default value for -T TEXT_START_ADDRESS
 */
...
#ifndef TEXT_START_ADDRESS
int	text_start;		/* start of text */
#else
int 	text_start = TEXT_START_ADDRESS;
#endif
