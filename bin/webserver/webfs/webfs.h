...
int webfs_open (char *, int, umask_t);
...
int webfs_mkdir (char *, umask_t);
int webfs_unlink (char *);
int webfs_fstat (int fd, struct alfs_stat *buf);
int webfs_stat (char *pathname, struct alfs_stat *buf);
