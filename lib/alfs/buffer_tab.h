...
bufferHeader_t *alfs_buffertab_findEntry (bufferCache_t *, block_num_t, block_num_t, block_num_t, int);
bufferHeader_t *alfs_buffertab_getEmptyEntry (bufferCache_t *, block_num_t, block_num_t, block_num_t);
void alfs_buffertab_markFree (bufferCache_t *, bufferHeader_t *);
void alfs_buffertab_markInvalid (bufferCache_t *, bufferHeader_t *);
...
void buffertab_shutdown (bufferCache_t *);
