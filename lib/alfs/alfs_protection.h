...
#ifndef __ALFS_PROTECTION_H__
#define __ALFS_PROTECTION_H__

#include "alfs/alfs_general.h"
#include "alfs/alfs.h"

/* some globals that define who we are defined in protection.c */
