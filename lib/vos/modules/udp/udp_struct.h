...
#ifndef __VOS_UDP_STRUCT_H__
#define __VOS_UDP_STRUCT_H__

#include <vos/net/fast_ip.h>
#include <vos/net/fast_eth.h>
#include <vos/net/fast_udp.h>
...
#define RECVFROM_BUFSIZE MAXUDP /* 1514 */

#define NR_RINGBUFS        1024
#define DEFAULT_NR_UDPBUFS  512
