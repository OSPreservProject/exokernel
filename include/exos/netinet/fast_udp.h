...
#ifndef _FAST_UDP_H_
#define _FAST_UDP_H_
#include <aegis/aegis.h>	/* recv struct */
#include <netinet/fast_ip.h>	/* includes types */
...
#define MAXUDP	1514
#else
#define MAXUDP	3*OTTO_RECVBUFSIZ
#endif
...
struct udp_session {
	...
	uint16 ash_id; 	/* a pointer to any ash that was downloaded(?) */
