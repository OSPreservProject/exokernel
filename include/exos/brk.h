...
/* -1 if not inited, 0 if don't zero the heap, otherwise, zero the heap */
/* If it's -1 and the HEAP_ZERO environment variable exists then it will be set
   to 1, else 0 */
extern int _exos_brk_heap_zero;
