...
#ifndef __VOS_INET_CKSUM_H__
#define __VOS_INET_CKSUM_H__
...
fold_32bit_checksum (uint32 sum)
{
...
unsigned short inet_cksum_recv_cheat
  (struct ae_recv *a, unsigned long count, unsigned long start);
