...
#ifndef __VOS_FAST_ARP_H__
#define __VOS_FAST_ARP_H__

#include <vos/net/fast_eth.h>

#define arp_offset(field) ((u_int) &((struct arp *) 0)->field)
#define arp_sz (sizeof (struct arp))
...
#define ARP_RESEND_RETRIES 10     /* 10 retries */
#define ARP_TABLE_SIZE 32


#endif /* __VOS_FAST_ARP_H__ */
