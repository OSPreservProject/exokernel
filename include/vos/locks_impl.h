...
#ifndef __VOS_LOCKS_IMPL_H__
#define __VOS_LOCKS_IMPL_H__
...
/* types of locks
 *
 * spinlock: wait-in-cache spinlock
 * queuelock: spinlock with tickets
 * rwlock: read-write lock
 * yieldlock: yields to lock owner
 * cpulock: grab hold of CPU, disallow context switch (works on uniprocessor)
 */
...
typedef struct 
{      
  volatile u_int lock;	/* 0 if unused, envid otherwise */
  short depth;		/* recursive locking depth */
} yieldlock_t;
